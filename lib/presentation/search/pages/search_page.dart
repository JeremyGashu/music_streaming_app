    ...
    return BlocBuilder<SearchBloc, SearchState>(builder: (context, state) {
      return DefaultTabController(
        ...
        child: Scaffold(
          ...
          appBar: AppBar(
            toolbarHeight: !(state is searchState.InitialState) ? 109 : 60,
            leading: null,
            // leading: Container(),
                  ...
                  child: Column(
                    children: [
                      ...
                      Container(
                        ...
                        child:
                            BlocBuilder<UserDownloadBloc, UserDownloadState>(
                        ...
                        child: BlocBuilder<NewReleaseBloc, NewReleaseState>(
                          builder: (ctx, state) {
                            if (state is LoadingNewReleases) {
                              ...
                              return state.newRelease.albums.length > 0?  ListView.builder(
                              ...
                              ) :  Center(child: Text('No newly releasd album!'),);
                        ...
                        child: BlocBuilder<NewReleaseBloc, NewReleaseState>(
                          builder: (ctx, state) {
                            if (state is LoadingNewReleases) {
                              ...
                              return state.newRelease.songs.length > 0 ? ListView.builder(
                              ...
                              ) : Center(child: Text('No newly releasd song!'),);
                            } else if (state is LoadingNewReleasesError) {
                              return CustomErrorWidget(
                                  onTap: () {
                                    BlocProvider.of<NewReleaseBloc>(context)
