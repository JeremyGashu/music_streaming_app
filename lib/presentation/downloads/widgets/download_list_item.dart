...
class DownloadListItem extends StatelessWidget {
  ...
  DownloadListItem({@required this.downloadTask}):assert(downloadTask != null);
  @override
  Widget build(BuildContext context) {
    return ListTile(
      ...
      leading: Container(
        ...
        height: 40,
        child:
        Image.network(downloadTask.coverImageUrl,),
      ),
      subtitle: Text("Progress ${downloadTask.progress}"),
      trailing: IconButton(
        onPressed: (){
          showDialog(context: context, builder: (context) => AlertDialog(
            ...
            actions: [
              ...
              TextButton(onPressed: (){
                BlocProvider.of<UserDownloadBloc>(context).add(DeleteDownload(trackId: downloadTask.songId));
                Navigator.pop(context);
              }, child: Text("yes")),
            ],
          ),);
