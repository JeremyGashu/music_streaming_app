...
final PLAYLIST_URL =
    'http://138.68.163.236:8889/v1/playlists/?page=1&per_page=20&sort=ASC';
final ALBUM_URL =
    'http://138.68.163.236:8889/v1/albums?page=1&per_page=20&sort=ASC';
final BASE_ALBUM_URL = 'http://138.68.163.236:8889/v1/albums';
final ARTIST_URL =
    'http://138.68.163.236:8889/v1/artists/?page=1&per_page=20&sort=ASC';
final SONG_URL =
    'http://138.68.163.236:8889/v1/songs?page=1&per_page=20&single=true';
final FEATURED_URL =
    'http://138.68.163.236:8889/v1/featured/albums?page=1&per_page=20';
...
final SONG_BY_ARTIST =
    'http://138.68.163.236:8889/v1/songs/?page=1&per_page=20&sort=DESC&search_by=artist_id&search_key=';
final ALBUM_BY_ARTIST =
    'http://138.68.163.236:8889/v1/albums?page=1&per_page=20&sort=ASC&search_by=artist_id&search_key=';
final NEW_RELEASE =
    'http://138.68.163.236:8889/v1/new_releases?page=1&per_page=20';
